        ...
        /> */}
          <Link href="/">
            <NavbarBrand>
              ...
              {!imageLoaded && (
                  <Skeleton className="w-40 h-10 rounded-md mx-auto aspect-[2/1]" />
                )}
                <Image
                  width={60}
                ...
                />
              <h1 className="text-sm sm:text-xl font-extrabold bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">
                JnUITS FEST
              </h1>
              </div>
            </NavbarBrand>
          ...
          {menuItems.map((item, index) => (
            <NavbarItem key={`${item.label}-${index}`} isActive={item.isActive}>
              <Link
                className={
                  item.isActive
                    ? "font-extrabold bg-gradient-to-r from-fuchsia-500 to-cyan-400 bg-clip-text text-transparent"
                    : ""
                }
                href={item.path}
              >
            ...
            <DrawerContent>
              <div className="mx-auto w-full max-w-sm text-left">
                <DrawerHeader>
                  ...
                  <DrawerDescription>
                    Prof. Ayesha Rahman:{" "}
                    <Link href={"mailto:ayesha.rahman@universitybd.edu"}>
                      ayesha.rahman@universitybd.edu
                    </Link>
                  </DrawerDescription>
                  <DrawerDescription>
                    Prof. Farhana Ahmed:{" "}
                    <Link href={"mailto:farhana.ahmed@universitybd.edu"}>
                      farhana.ahmed@universitybd.edu
                    </Link>
                  </DrawerDescription>
                  <DrawerTitle>Student Co-ordinators</DrawerTitle>
                  <DrawerDescription>
                    Tanvir:{" "}
                    <Link href={"tel:+880 1712345678"}> +880 1712345678 </Link>
                  </DrawerDescription>
                  <DrawerDescription>
                    Nafis:{" "}
                    <Link href={"tel:+880 1912345678"}> +880 1912345678 </Link>
                  </DrawerDescription>
                  <DrawerDescription>
                    Rafiq:{" "}
                    <Link href={"tel:+880 1812345678"}> +880 1812345678 </Link>
                  </DrawerDescription>
                  <DrawerDescription>
                    Shuvo:{" "}
                    <Link href={"tel:+880 1512345678"}> +880 1512345678 </Link>
                  </DrawerDescription>
                </DrawerHeader>
              ...
              <DrawerContent>
                <div className="mx-auto w-full max-w-sm text-left">
                  <DrawerHeader>
                    ...
                    <DrawerDescription>
                      You have to do fees payment after just filling up this
                      Registration Form.
                    </DrawerDescription>
                    <DrawerDescription>
                      Contact below mentioned Co-ordinators for Fees Payment.
                    </DrawerDescription>
                    <Separator className="my-2"></Separator>
                    <DrawerTitle>Contact for Fees Payment</DrawerTitle>
                    <DrawerDescription>
                      Vaishnavi:{" "}
                      <Link href={"tel:+880 6355384251"}>
                        {" "}
                        +880 6355384251{" "}
                      </Link>
                    </DrawerDescription>
